...
return db.query("select * from blog_tbl where blog_id=?",[id],callback);
 ...
 return db.query("Insert into blog_tbl values(?,?,?,?,?,?,?,?,?)",[Blog.blog_id,Blog.blog_title,Blog.blog_desc,Blog.blog_date,Blog.blog_time,Blog.blog_photo,Blog.view,Blog.fk_u_email_id,Blog.fk_sub_id],callback);
 },
